...
%>
    ...
    <div class="container">
        <div class="row">
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                <thead>
                    <tr>
                        ...
                        <th style="background-color:#eeeeee; text-align:center;">상세 주소</th>
                        <th style="background-color:#eeeeee; text-align:center;">가게 카테고리</th>
                    </tr>
                </thead>
                <tbody>
                <% 
                String market_address_1=request.getParameter("market_address_1");
            	String market_address_2=request.getParameter("market_address_2");
            	String market_address_3=request.getParameter("market_address_3");
      
            	if( market_address_1  != null) {
                	MarketDAO marketDAO = new MarketDAO();
                	ArrayList<Market> list = null;
                if(Division==1) {
                    list = marketDAO.Search_getList(last_num, market_address_1, market_address_2, market_address_3, Division);
                ...
                %>
                    ...
                    <tr>
                        ...
                        <td><%=list.get(i).getMarket_address1() %> <%=list.get(i).getMarket_address2() %> <%=list.get(i).getMarket_address3() %>  </td>
                        <td><%=list.get(i).getMarket_detailed_address() %></td>
                ...
                %>
                    ...
                    <tr>
                        ...
                        <td><%=list.get(list.size() -i -1).getMarket_address1() %> <%=list.get(list.size() -i -1).getMarket_address2() %> <%=list.get(list.size() -i -1).getMarket_address3() %></td>
                        <td><%=list.get(list.size() -i -1).getMarket_detailed_address() %></td>
            ...
            <%
                } if (marketDAO.Search_nextPage(last_num, market_address_1, market_address_2, market_address_3, Division)) {
